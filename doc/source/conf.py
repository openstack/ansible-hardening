...
copyright = '2015-2016, OpenStack-Ansible contributors'
description = ("openstack-ansible-security applies security hardening to"
               "OpenStack hosts.")
project = 'openstack-ansible-security'
target_name = 'openstack-ansible-security'
title = "openstack-ansible-security Documentation"
...
htmlhelp_basename = "{0}-docs".format(target_name)
